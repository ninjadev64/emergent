...
<!-- Core components -->
<GenericInspector on:update={update} name="Transform" bind:this={transform} object={sprite.transform} props={{ "x": { type: "number", name: "X" }, "y": { type: "number", name: "Y" }, "width": { type: "number", name: "Width" }, "height": { type: "number", name: "Height" } }} />
<GenericInspector on:update={update} name="Material" bind:this={material} object={sprite.render} props={{ "fillStyle": { type: "text", name: "Fill style" }, "opacity": { type: "number", name: "Opacity" }, "lineWidth": { type: "number", name: "Line width" } }} />
<GenericInspector on:update={update} name="Image" bind:this={image} object={sprite.render.sprite} props={{ "texture": { type: "text", name: "Texture path" }, "xOffset": { type: "number", name: "X offset" }, "yOffset": { type: "number", name: "Y offset" }, "xScale": { type: "number", name: "X scale" }, "yScale": { type: "number", name: "Y scale" } }} />
<GenericInspector on:update={update} name="Body" bind:this={body} object={sprite.body} props={{ "isStatic": { type: "boolean", name: "Static" }, "density": { type: "number", name: "Density" }, "friction": { type: "number", name: "Friction" }, "frictionAir": { type: "number", name: "Air resistance" } }} />
